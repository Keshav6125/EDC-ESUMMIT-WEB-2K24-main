  ...
  return (
    <>
      {description ? (
        ...
        opacity-800  min-[768px]:bg-black min-[768px]:bg-opacity-40  min-[768px]:rounded min-[768px]:drop-shadow-lg 
         p-[20x] rounded-[10px] pb-[15px] hover:scale-105 duration-300 transition ease-in-out relative">
          <div className="flex justify-evenly items-center flex-col">
            ...
            <div>
            <p className=" px-[5px]  text-amber-500  font-bold">{desc}</p>
            </div>
        ...
        <div className=" border-[5px] border-[#F0A500] h-[420px] w-[280px] bg-white p-[20x] rounded-[10px] hover:scale-105 duration-300 relative">
