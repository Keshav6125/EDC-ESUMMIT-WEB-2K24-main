    ...
    <>
      ...
      >
        ...
        <SwiperSlide >
          ...
          <img className="col-span-1 rounded-2xl border-2" src={boardroom}/>
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl"> Pentagon</h1>
        ...
        <SwiperSlide>
        < div className="grid grid cols-2 ">
          <img class="past" className="col-span-1 rounded-2xl border-2 " src={bplan}/>
          <div className="col-span-1 text-white " >
             <h1 className="text-amber-500 font-bold text-2xl"> Unicorn League</h1>
        ...
        < div className="grid grid cols-2 p-5 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Sahifolio Challenge</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Spike Rush</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">OG Karts</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Bellagio</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">IPL Kickoff's</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Bizalytics</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Pennywise</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">The Fued</h1>
        ...
        < div className="grid grid cols-2 ">
          ...
          <div className="col-span-1 text-white rounded-2xl" >
             <h1 className="text-amber-500 font-bold text-2xl">Under Pressure</h1>
